	...
	{/if}
		<ul>
			<li><ul>
				...
				<li><a href="A2B_asteriskinfo.php?section=10">{php} echo "Asterisk Info";{/php}</a></li>
				<li><a href="A2B_phpsysinfo.php?section=10">{php} echo "phpSysInfo";{/php}</a></li>
				<li><a href="A2B_phpinfo.php?section=10">{php} echo "phpInfo";{/php}</a></li>
				<li><a href="phpconfig.php?dir=/etc/asterisk&section=10">{php} echo gettext("Asterisk config");{/php}</a></li>
			</ul></li>
		</ul>
	</div>
	</div>
