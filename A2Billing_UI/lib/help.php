...
{
	return gettext("For further information please consult").' <a target="_blank" href="http://trac.asterisk2billing.org/cgi-bin/trac.cgi/wiki/1-3-'.$wiki_article_name.'">'.gettext("the online documention").'</a>.<br/>';
}
...
<br/>'.help_wiki_link('CreateVoucher').'<br/>
</div></div></div>
</div></div>';
...
<br/>'.help_wiki_link('ViewPaymentMethods').'<br/><br>
</div></div></div>
</div></div>
'; 
