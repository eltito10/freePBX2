<?php /* Smarty version 2.6.13, created on 2008-09-25 14:24:36
         compiled from main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'checkseleted', 'main.tpl', 465, false),)), $this); ?>
<HTML>
<HEAD>
	...
	<?php endif; ?>
		<ul>
			<li><ul>
				...
				<li><a href="A2B_asteriskinfo.php?section=10"><?php  echo "Asterisk Info"; ?></a></li>
				<li><a href="A2B_phpsysinfo.php?section=10"><?php  echo "phpSysInfo"; ?></a></li>
				<li><a href="A2B_phpinfo.php?section=10"><?php  echo "phpInfo"; ?></a></li>
				<li><a href="phpconfig.php?dir=/etc/asterisk&section=10"><?php  echo gettext("Asterisk config"); ?></a></li>
			</ul></li>
		</ul>
	</div>
	</div>
