<?php /* $Id: call-log.php 9511 2010-04-17 21:54:27Z p_lindheimer $ */
...
//	$FG_TABLE_COL[]=array ("Channel", "channel", "13%", "center", "", "30", "", "", "", "", "", "display_acronym");
	...
	$FG_TABLE_COL[]=array ("Clid", "clid", "20%", "center", "", "50",'','','','','','filter_html');
	$FG_TABLE_COL[]=array ("Dst", "dst", "14%", "center", "SORT", "30");
	$FG_TABLE_COL[]=array ("IdDeudor", "deudor", "13%", "center", "", "30");
	$FG_TABLE_COL[]=array ("Negocio", "negocio", "13%", "center", "", "30");
	$FG_TABLE_COL[]=array ("Disposition", "disposition", "12%", "center", "", "40");
	if ((!isset($resulttype)) || ($resulttype=="min")) $minute_function= "display_minute";
	$FG_TABLE_COL[]=array ("Duration", "duration", "12%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");
	$FG_TABLE_COL[]=array ("Billsec", "billsec", "12%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");
	$FG_TABLE_COL[]=array ("Cost", "userfield", "12%", "center", "", "30");
	$FG_TABLE_COL[]=array ("", "uniqueid", "8%", "center", "", "20");
	...
	$FG_COL_QUERY='calldate, src, clid, dst, deudor, negocio, disposition, duration, billsec, userfield, uniqueid';
...
<TBODY>
				...
				?>
						...
						<TD vAlign=top align="<?php echo $FG_TABLE_COL[$i][3]?>" class=tableBody><?php  echo $ligne_number+$current_page*$FG_LIMITE_DISPLAY.".&nbsp;"; $record = array(); ?></TD>
						...
						<?php 	//$FG_TABLE_COL[$i][1];			
						 ...
						 if (isset ($FG_TABLE_COL[$i][12]) && strlen($FG_TABLE_COL[$i][12])>1){
						 		call_user_func($FG_TABLE_COL[$i][12], $record_display);
						 }else{
						 ...
						 ?></TD>
				 		 <?php  } echo "<td><a href=http://192.168.1.12/admin/cdr/audio.php?uid=$record[10]&dia=$record[0]><IMG border=0 src='images/sound.png'></a></td>"; ?>
