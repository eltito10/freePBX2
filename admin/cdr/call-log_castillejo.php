...
//	$FG_TABLE_COL[]=array ("Channel", "channel", "13%", "center", "", "30", "", "", "", "", "", "display_acronym");
	...
	$FG_TABLE_COL[]=array ("Clid", "clid", "26%", "center", "", "60",'','','','','','filter_html');
	$FG_TABLE_COL[]=array ("Dst", "dst", "14%", "center", "SORT", "30");
	$FG_TABLE_COL[]=array ("IdDeudor", "accountcode", "13%", "center", "", "30");
	$FG_TABLE_COL[]=array ("Negocio", "userfield", "13%", "center", "", "30");
	$FG_TABLE_COL[]=array ("Disposition", "disposition", "9%", "center", "", "40");
	if ((!isset($resulttype)) || ($resulttype=="min")) $minute_function= "display_minute";
	$FG_TABLE_COL[]=array ("Duration", "duration", "6%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");
	...
	$FG_COL_QUERY='calldate, src, clid, dst, accountcode, userfield, disposition, duration, billsec, uniqueid';
...
<TBODY>
				...
				?>
						...
						<?php 	//$FG_TABLE_COL[$i][1];			
						 ...
						 ?></TD>
				 		 <?php  } echo "<td><a href=http://192.168.1.12/admin/cdr/audio.php?uid=$record[9]><IMG border=0 src='images/sound.png'></a></td>"; ?>
